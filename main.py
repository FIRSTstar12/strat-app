...
# Main Program
seasonOrLifetime = "s"
compare = input("Would you like to compare two teams?(y/n): ")
clear()
teamNumber = int(input("What team do you want to look for?: "))
if compare == "n":
    clear()
    seasonOrLifetime = input("Would you like to look for season stats or lifelong stats?(s/l)")
else:
    otherTeam = int(input(f"What team do you want to compare to {teamNumber}?: "))

data = getTeam(teamNumber)
if data:
    if(seasonOrLifetime == "l"):
